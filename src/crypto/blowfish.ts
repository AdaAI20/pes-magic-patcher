// src/crypto/blowfish.ts
// Complete Blowfish implementation for PES EDIT files
...
export class Blowfish {
  ...
  private F(x: number): number {
    ...
    let result = (this.S[0][a] + this.S[1][b]) >>> 0;
    result = (result ^ this.S[2][c]) >>> 0;
    result = (result + this.S[3][d]) >>> 0;
    return result;
  }
  ...
  decrypt(data: Uint8Array): Uint8Array {
    ...
    for (let i = 0; i < data.length - 7; i += 8) {
      const l = view.getUint32(i, false); // Big-endian
